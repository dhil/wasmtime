...
use crate::runtime::vm::continuation::optimized::StackChainCell;
...
impl Instance {
    ...
    // NOTE(dhil): This method is currently not invoked when
    // `typed_continuations_baseline_implemented` is toggled.
    #[allow(dead_code)]
