...
/// Side table mapping the IDs stored in GC fields to complete
/// continuation objects, including their revision witnesses.
///
/// Raw ID zero is reserved for a null continuation
/// reference. Non-null IDs are one greater than their underlying slab
/// IDs.
#[derive(Default)]
