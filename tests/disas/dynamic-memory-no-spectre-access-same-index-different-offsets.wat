...
;;     gv5 = load.i64 notrap aligned checked gv3+104
;;     stack_limit = gv2
;;
;;                                 block0(v0: i64, v1: i64, v2: i32):
;; @0047                               v7 = load.i64 notrap aligned v0+112
;; @0047                               v6 = uextend.i64 v2
;; @0047                               v8 = icmp ugt v6, v7
;; @0047                               trapnz v8, heap_oob
;; @0047                               v9 = load.i64 notrap aligned checked v0+104
;; @0047                               v10 = iadd v9, v6
...
;; @005d                               v7 = load.i64 notrap aligned v0+112
;; @005d                               v6 = uextend.i64 v2
;; @005d                               v8 = icmp ugt v6, v7
;; @005d                               trapnz v8, heap_oob
;; @005d                               v9 = load.i64 notrap aligned checked v0+104
;; @005d                               v10 = iadd v9, v6
