...
;;     gv2 = load.i64 notrap aligned gv1+16
;;     gv3 = vmctx
;;     gv4 = load.i64 notrap aligned readonly gv3+96
;;     sig0 = (i64 vmctx, i64, i32, i32, i32, i32) -> i32 tail
;;     stack_limit = gv2
;;
;;                                 block0(v0: i64, v1: i64, v2: i32, v3: i32, v4: i32, v5: i32):
;; @0048                               v12 = load.i64 notrap aligned readonly v0+96
;;                                     v48 = iconst.i64 8
...
;;
;;                                 block0(v0: i64, v1: i64, v2: i32, v3: i32, v4: i32, v5: i32):
;; @0075                               v12 = load.i64 notrap aligned readonly v0+96
;;                                     v48 = iconst.i64 8
;; @0075                               v14 = iadd v12, v48  ; v48 = 8
;; @0075                               v17 = load.i64 user5 aligned table v14
;; @0075                               v18 = load.i64 user6 aligned readonly v17+8
...
;; @0087                               v31 = load.i64 user5 aligned table v28
;; @0087                               v32 = load.i64 user6 aligned readonly v31+8
