...
;; @0040                               v4 = load.i64 notrap aligned v0+112
;; @0040                               v5 = icmp ugt v2, v4
;; @0040                               trapnz v5, heap_oob
;; @0040                               v6 = load.i64 notrap aligned checked v0+104
;; @0040                               v7 = iadd v6, v2
...
;; @004c                               v4 = load.i64 notrap aligned v0+112
;; @004c                               v5 = icmp ugt v2, v4
;; @004c                               trapnz v5, heap_oob
;; @004c                               v6 = load.i64 notrap aligned checked v0+104
;; @004c                               v7 = iadd v6, v2
