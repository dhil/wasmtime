...
;; @0041                               v5 = load.i64 notrap aligned v0+112
;; @0041                               v6 = icmp uge v4, v5
;; @0041                               trapnz v6, heap_oob
;; @0041                               v7 = load.i64 notrap aligned checked v0+104
;; @0041                               v8 = iadd v7, v4
...
;; @0049                               v5 = load.i64 notrap aligned v0+112
;; @0049                               v6 = icmp uge v4, v5
;; @0049                               trapnz v6, heap_oob
;; @0049                               v7 = load.i64 notrap aligned checked v0+104
;; @0049                               v8 = iadd v7, v4
